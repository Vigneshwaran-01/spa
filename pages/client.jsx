...
export default function ClientNew({ clientData, error }) {
  ...
  return (
    <div>
      <Head>
      <title>Intrusion prevention service with SpamCloud's email security</title>
        <meta name="description" content="SpamCloud provides an intrusion prevention service that maintains your business trust, domain reputation, and IP reputation with reliable email security" />
	...
	<meta property="og:description" content="SpamCloud provides an intrusion prevention service that maintains your business trust, domain reputation, and IP reputation with reliable email security" />
