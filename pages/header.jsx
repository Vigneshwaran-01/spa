...
export default function Header() {
  ...
  const dropdownClassesBase = "absolute top-full left-1/2 -translate-x-1/2 mt-2 w-48 bg-gray-800 rounded-lg shadow-xl border border-gray-700 transition-all duration-200 z-[10000] pointer-events-auto overflow-hidden";
  const dropdownLinkClasses = "block px-4 py-2.5 text-white hover:bg-gray-700 hover:text-emerald-400 transition-colors duration-200 text-sm whitespace-nowrap";
