...
const outgoingFilterNew = () => {
  ...
  return (
    <div>
      <Head>
        <title>Email Security Gateway with Outgoing Spam Filter | Secure Mail</title>
        <meta name="description" content="Spam Cloud offers an efficient outgoing spam filter service to safeguard your emails and enhance security from external threats using an Email security gateway" />
        ...
        <meta property="og:description" content="Spam Cloud offers an efficient outgoing spam filter service to safeguard your emails and enhance security from external threats using an Email security gateway" />
