...
export default function New({ homeData, error }) {
  ...
  return (
	...
	<meta property="og:description" content='SpamCloud Email Security Services protects your information, prevents financial fraud, and maintains organizational trust with an intrusion prevention service' />
  ...
  <script
      ...
      <section className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute w-full h-1 bg-gradient-to-r  to-transparent opacity-60 animate-scan"></div>
        </div>
            ...
            <div className="w-full max-w-2xl">
              <div className="text-left">
                ...
                <p className="text-lg lg:text-xl ml-2 text-gray-300 mb-8 leading-relaxed max-w-lg font-light">
                 SpamCloud Protects and Maintains Your Organizational Trust with Advanced Email Security Solutions
                </p>

                {/* Dual CTA Buttons */}
                <div className="flex flex-col sm:flex-row gap-4 mb-6">
                  {/* Primary CTA - Schedule a Demo Call */}
                  <Link href="#contactForm" className={`group relative inline-flex items-center justify-center bg-blue-600 hover:bg-blue-500 text-white  px-6 py-3 rounded-full font-bold text-base transition-all duration-300  hover:-translate-y-1 overflow-hidden ${isClient ? css(styles.slideInDown) : ""}`}>
          ...
          <div className="row g-4">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="proofpoint-service-card">
                ...
                <h3 className='text-black'>Email Archiving & Compliance</h3>
            ...
            <div className="col-lg-3 col-md-6">
              <div className="proofpoint-service-card">
                ...
                <h3 className='text-black'>Carbonio Mail Platform</h3>
